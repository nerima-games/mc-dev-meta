# plan.md §6 Step 2 の横断状況 —— 「プレビューが操作可能」なリポジトリは **3 / 15**
...
したがって残る 12 件は 12 個の独立した遅れではなく、**1 本の連鎖の未着手**である。
...
**mc-worldgen / mx-redstone / mx-ui の 3 本がそれを反証した。** 端末 ANSI で描くプレビューは kit も publish も
...
インベントリのように「状態を見る」プレビューは、いま作れる。残り 12 件のうち
どれがどちらかは §3 の内訳を見ること。一人称操作が本質なのは mc-sim の障害物コースだけである。
