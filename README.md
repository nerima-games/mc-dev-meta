...
| ミラー | 置き場所 | ミラー元 |
| --- | --- | --- |
| `src/domain/frame-contract.ts` | mx-gameplay / mx-multiplayer / mx-ui | mc-kernel |
| `src/domain/lod-vocabulary.ts` | mc-render | mc-meshing |
| `src/domain/block-vocabulary.ts` | mx-gameplay | mc-kernel |
